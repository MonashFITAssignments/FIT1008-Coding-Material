...
def check_bst_invariant(node: BinaryNode | None, l = None, r = None) -> bool:
    ...
    return (check_bst_invariant(node._left, l, node.key) and 
            check_bst_invariant(node._right, node.key, r))
...
class TestBinarySearchTree(TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(left_str, "BinarySearchTree(14, 14, (13, 13, (12, 12, (11, 11, (10, 10, (9, 9, (8, 8, (7, 7, (6, 6, (5, 5, (4, 4, (3, 3, (2, 2, (1, 1, (0, 0, None, None), None), None), None), None), None), None), None), None), None), None), None), None), None), None)")

        right_str = str(self.right_tree)
        self.assertEqual(right_str, "BinarySearchTree(0, 0, None, (1, 1, None, (2, 2, None, (3, 3, None, (4, 4, None, (5, 5, None, (6, 6, None, (7, 7, None, (8, 8, None, (9, 9, None, (10, 10, None, (11, 11, None, (12, 12, None, (13, 13, None, (14, 14, None, None)))))))))))))))")

        balanced_str = str(self.balanced)
        self.assertEqual(balanced_str, "BinarySearchTree(7, 7, (3, 3, (1, 1, (0, 0, None, None), (2, 2, None, None)), (5, 5, (4, 4, None, None), (6, 6, None, None))), (11, 11, (9, 9, (8, 8, None, None), (10, 10, None, None)), (13, 13, (12, 12, None, None), (14, 14, None, None))))")
...
#         empty_str = self.empty.str_2d()
#         self.assertEqual(empty_str, "None")
        
#         one_str = self.one.str_2d()
#         self.assertEqual(one_str, "(0, 0)")

#         left_str = self.left_tree.str_2d()
...
# ╙═""")
#         self.maxDiff = None
#         right_str = self.right_tree.str_2d()
...
#         balanced_str = self.balanced.str_2d()
